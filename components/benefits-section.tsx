    ...
    <section className="py-20 bg-secondary/20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-balance">
          Por que traders escolhem a <span className="text-[#FFDF00]">mesa</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {benefits.map((benefit, i) => {
            ...
            return (
              <Card 
                key={i}
                className="bg-card/50 border-border/50 hover:border-[#009C3B]/50 transition-colors"
              >
                <CardContent className="p-6">
                  <div className="w-12 h-12 rounded-xl bg-[#009C3B]/10 flex items-center justify-center mb-4">
                    <Icon className="w-6 h-6 text-[#009C3B]" />
                  </div>
